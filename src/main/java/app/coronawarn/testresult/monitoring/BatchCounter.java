...
public class BatchCounter {
  ...
  private static final String TESTRESULT_CONTROLLER_REQUESTS_COUNTER_NAME = "testresult_controller.test_requests";
  private static final String TESTRESULT_CONTROLLER_REQUESTS_COUNTER_DESCRIPTION
  ...
  BatchCounter(MeterRegistry meterRegistry, long batchSize, String type) {
    ...
    counter = Counter.builder(TESTRESULT_CONTROLLER_REQUESTS_COUNTER_NAME)
        .tag("type", type)
        .description(TESTRESULT_CONTROLLER_REQUESTS_COUNTER_DESCRIPTION)
